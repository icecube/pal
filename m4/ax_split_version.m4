...
AC_DEFUN([AX_SPLIT_VERSION],[
    ...
    AX_INTEGER_VERSION=`expr $AX_MAJOR_VERSION \* 1000000 + $AX_MINOR_VERSION \* 1000 + $AX_POINT_VERSION`
    ...
    AC_MSG_CHECKING([Integer version])
    AC_MSG_RESULT([$AX_INTEGER_VERSION])
])
